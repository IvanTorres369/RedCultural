			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right animate">
						...
						<li><a href="cursos.php">Lecciones</a></li>
							...
							<div class="col-sm-3">
								<div class="chart">
									<div class="skill" data-percent="20">
										<span class="percent"><a href="introduccion.php">IR</a></span>
									</div>
									<h3>INTRODUCCIÓN (TLATSINTILISTLI)</h3>
								</div>
							</div>
							<div class="col-sm-3 ">
								<div class="chart">
									<div class="skill" data-percent="20">
										<span class="percent"><a href="leccion1.php">LECCIÓN 1</a></span>
									</div>
									<h3>PERSONAS (TLACATL)</h3>
								</div>
							</div>
							<div class="col-sm-3">
								<div class="chart">
									<div class="skill" data-percent="85">
										<span class="percent"><a href="leccion2.php">LECCIÓN 2</a></span>
									</div>
									<h3>COMIDA (TLAKUALI)</h3>
								</div>
							</div>
							<div class="col-sm-3">
								<div class="chart">
									<div class="skill" data-percent="94">
										<span class="percent"><a href="leccion3.php">LECCIÓN 3</a></span>
									</div>
									<h3>ANIMALES Y COSAS (YOLKAMEJ Y TLANETIA)</h3>
								</div>
							</div>
						</div>
					</div>
