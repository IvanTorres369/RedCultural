...
<?php
	...
	$nombreArchivo = '../PalabrasTraductor2.xlsx';
	...
	echo '<table border=1>
		  <tr><td>Español</td><td>Otomi</td></tr>';
		  
	for($i = 2; $i < $numRows; $i++){
		$espanol = $objPHPExcel->getActiveSheet()->getCell('A'.$i)->getCalculatedValue();
		$otomi = $objPHPExcel->getActiveSheet()->getCell('B'.$i)->getCalculatedValue();
		...
		$sql = "INSERT INTO traductor2(espanol,otomi) 
		        VALUE('$espanol','$otomi')";
