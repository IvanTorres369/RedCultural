...
<!DOCTYPE html>
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right animate">
						...
						<li><a href="../Vista/diccionarioadmin_otomi.php">Traductor</a></li>
	...
	//header('Location:vistausuario.php');
		...
		mysqli_close($con);
?>
	<br    /> <br    /><br      /> <br     /><br     /><br   /><a href="../Vista/frm_trad_otomi.html" style="color: white">Regresar a formulario</a>	
		</div>
	</div>
</div> 
</div> 
