			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					...
					<li><a href="vistausuario.php"></a></li>
						...
						<li><a href="../Vista/diccionariotmi.html">Traductor</a></li>
...
<section id="seccion">
	...
	if($_POST['P1']==null|$_POST['P2']==null|$_POST['P3']==null|$_POST['P4']==null|$_POST['P5']==null|$_POST['P6']==null|$_POST['P7']==null|$_POST['P8']==null|$_POST['P9']==null|$_POST['P10']==null){
	 ...
	 if(isset($_POST['terminar'])&&$_POST['P1']!=null&&$_POST['P2']!=null&&$_POST['P3']!=null&&$_POST['P4']!=null&&$_POST['P5']!=null&&$_POST['P6']!=null&&$_POST['P7']!=null&&$_POST['P8']!=null&&$_POST['P9']!=null&&$_POST['P10']!=null){
		...
		echo '</br>Continua con la siguiente sopa de letras<br>';
		echo '<br></br><a href="../SopaLetras_Otomi/index.html">Ir a la Actividad 1</a>';
		}
		...
		?>		
			...
			<a href="../Vista/leccion1_otomi.php" class="social-list" style="color:white" >Volver a intentar</a>
