...
var iTiempoTranscurrido=iPuntosObtenidos=0, iTiempoLimite=1000, objPrimero;
...
$(document).ready(function(){
	...
	$('ul li').live('click',function(){
		if(!blnJuegoFinalizado && $(this).css('opacity')!=0){
			var strImagen='img/frutas/'+$(this).attr('rel')+'.jpg';
	...
	$.fntFinalizarJuego=function(){
		...
		$('#divContador').find('p').html('<strong>Puntos obtenidos: </strong>'+iPuntosObtenidos+
		' &bull; <strong>Tiempo empleado: </strong>'+iTiempoTranscurrido+' <strong><a href="Diploma2/ejemplo1.html"><br></br>................</a><br>Generar diploma</strong>');
