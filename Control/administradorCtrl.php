		...
		<div class="navbar navbar-smak navbar-fixed-top " id="navbar" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand animate" href="../index.html"><img src="../img/delta.png" alt="logo1"></a>
				</div>
	...
	<section id="seccion2">
		<div class="branded-section numbers">
			...
			<?php
				...
				$adm->conectar();
					if ($_POST['registrar']){
						$adm->inicializar($_REQUEST['id_admin'],$_REQUEST['nombre'],$_REQUEST['apellido_pat'],$_REQUEST['apellido_mat'],$_REQUEST['correo'],$_REQUEST['contra']);
						$adm->registrarAdministrador();
					}
					if ($_POST['iniciar']){
						$adm->iniciaSesion($_REQUEST['id_admin'],$_REQUEST['contra']);
					}
					if ($_POST['modificar']){
						$adm->datosAdministrador($_POST['id_admin']);
					}
					if ($_POST['modificar1']){
						$adm->modificaDatosAdministrador($_POST['nombre'],$_POST['correo'],$_POST['contrasena'],$_POST['id_admin']);
					}
				$adm->desconectar();
			?>	
					</div>
